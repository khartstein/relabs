function varargout = Flip2(win,varargin)
% PTB.Window.Flip2
% 
% Description:	flip the main window without clearing
% 
% Syntax:	t = win.Flip2([strInfo]=<nothing>)
% 
% In:
...
% License.
%
% Modified: 2016-01-06 from PTB.Window.Flip by Kevin Hartstein 
%   (kevinhartstein@gmail.com) 
...
tGS	= Screen('Flip',PTBIFO.window.h.main,[],1);
