...
%
% Notes: 
%       - CURRENTLY MESSING AROUND TO GET IMAGE SIZE CORRECT FOR SCANNER
%
% ToDo:      
...
% 3/28 - this size good for psychophysics room, too big for scanner
%         P.stim_size = struct(...
%                     'sqside'        ,   1.5         ,   ...
%                     'interstim'     ,   2.25        ,   ...
%                     'offset'        ,   6               ...
%                 );
% 3/28 - trying with this size
        P.stim_size = struct(...
                    'sqside'        ,   1.00      ,   ...
                    'interstim'     ,   1.50      ,   ...
                    'offset'        ,   4.00          ...
