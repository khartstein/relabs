function varargout = Sequence2(shw,cX,tShow,varargin)
% PTB.Show.Sequence
% 
% Description:	show a sequence of stimuli (edit: kh 1/26/16) without
%       clearing screen in between steps
% 
...
% License.
%
% Modified: 2016-01-26 by Kevin Hartstein (kevinhartstein@gmail.com)
global PTBIFO;
